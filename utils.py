...
def load_emb_matrix(vocab_size, emb_size, data):
  embedding_weights = {}
  f = open('/home/C/LD/pycharm-projects/bugretrieval/glove/glove.42B.{}d.txt'.format(emb_size), 'r')
  loop = tqdm(f)
...
if __name__ == '__main__':
  vocab = load_vocabulary('/home/C/LD/pycharm-projects/bugretrieval/data/word_vocab.pkl')
  for token in vocab:
    print(token)
